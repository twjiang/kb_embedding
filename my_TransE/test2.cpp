...
int main(int argc, char **argv)
{
    ...
    cout << id2entity[entity2id["Google"]] << "," << id2entity[entity2id["拉里·佩奇"]] << endl;
    
    ranked_map = link_prediction(entity2id["Google"], entity2id["拉里·佩奇"]);
    
    vector<PAIR> name_score_vec(ranked_map.begin(), ranked_map.end());  
    sort(name_score_vec.begin(), name_score_vec.end(), CmpByValue());   
    for (vector<PAIR>::iterator it=name_score_vec.begin(); it!=name_score_vec.end(); ++it) {  
        cout << id2relation[it->first] << " => " << it->second << '\n';  
    }  
    
    cout << id2entity[entity2id["中国"]] << "," << id2relation[relation2id["首都"]] << endl;
    
    ranked_map = entity_prediction(entity2id["中国"], relation2id["首都"]);
    
    vector<PAIR> name_score_vec2(ranked_map.begin(), ranked_map.end());  
    sort(name_score_vec2.begin(), name_score_vec2.end(), CmpByValue());   
    for (vector<PAIR>::iterator it=name_score_vec2.begin(); it!=name_score_vec2.end(); ++it) {  
        cout << id2entity[it->first] << " => " << it->second << '\n';  
    }  
    
    cout << id2entity[entity2id["百度"]] << "," << id2relation[relation2id["创始人"]] << endl;
    
    ranked_map = entity_prediction(entity2id["百度"], relation2id["创始人"]);
    
    vector<PAIR> name_score_vec3(ranked_map.begin(), ranked_map.end());  
    sort(name_score_vec3.begin(), name_score_vec3.end(), CmpByValue());   
    for (vector<PAIR>::iterator it=name_score_vec3.begin(); it!=name_score_vec3.end(); ++it) {  
        cout << id2entity[it->first] << " => " << it->second << '\n';  
    }
